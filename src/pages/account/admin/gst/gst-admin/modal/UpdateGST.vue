                ...
                <div class="modal-body">
                    <form @submit.prevent="handleSubmit">
                        ...
                        <div class="d-flex justify-content-between pt-3">
                            ...
                            <ButtonTertiary label="Update" class="w-50 " :disabled="loading" />
                        </div>
...
const statusOptions = ref(["RE-INITIATED", "APPROVED", "REJECTED"]);

const emit = defineEmits(['update-gst-details']);
...
watch(
    ...
    (newValue) => {
        ...
        form.monthyear = newValue.monthyear || "";
        errors.remark = "";
        errors.status = "";
        errors.message = "";
    }
...
const handleSubmit = async () => {
    ...
    if (!errors.status && !errors.remark) {
        loading.value = true;
        try {
            const response = await accountService.updateGST(form);
